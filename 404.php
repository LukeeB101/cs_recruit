          ...
          <div class="col-12 col-xl-10 col-xxl-8">
            <div class="row justify-content-center align-items-center g-5">
              ...
              <div class="col-12 col-lg-6 text-center text-lg-start"><img class="img-fluid mb-6 w-50 w-lg-75 d-dark-none" src="/assets/img/spot-illustrations/404.png" alt="" /><img class="img-fluid mb-6 w-50 w-lg-75 d-light-none" src="/assets/img/spot-illustrations/dark_404.png" alt="" />
                <h2 class="text-body-secondary fw-bolder mb-3">Oops!!!</h2>
                <p class="text-body mb-5">We are lost. Unfortunately we couldn't find that page. <br class="d-none d-sm-block" />It could be that this page has been removed or it can't be found. </p><a class="btn btn-lg btn-primary" href="/index">Go Home</a>
              </div>
            </div>
          </div>
        </div>
