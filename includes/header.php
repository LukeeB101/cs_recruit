<div class="bg-body-emphasis sticky-top" data-navbar-shadow-on-scroll="data-navbar-shadow-on-scroll">
    <nav class="navbar navbar-expand-lg container-small px-3 px-lg-7 px-xxl-3"><a class="navbar-brand flex-1 flex-lg-grow-0" href="/index.html">
        <div class="d-flex align-items-center"> <!-- <img src="/assets/img/icons/logo.png" alt="phoenix" width="27" /> -->
            <h5 class="logo-text ms-2">Castaway Systems</h5>
        </div>
        </a>
        <div class="d-lg-none">
        ...
        <div class="d-grid d-lg-flex align-items-center">
            ...
            </div><a class="btn btn-link text-body order-1 order-lg-0 ps-4 me-lg-2" href="/pages/authentication/simple/sign-in.html">Sign in</a><a class="btn btn-phoenix-primary order-0" href="/pages/authentication/simple/sign-up.html"><span class="fw-bold">Sign up</span></a>
        </div>
        </div>
    </nav>
</div>